...
enum {
    ...
    MUGSHOT_DRAKE,
    MUGSHOT_CHAMPION,
    MUGSHOT_DUKE_HORACIO,
    MUGSHOT_SIR_AMIK_VARZE,
    MUGSHOT_TZHAAR_CHAMPION,
    MUGSHOT_GUNTHOR,
    MUGSHOT_PRINCE_ALI,
    MUGSHOT_KING_ROALD,
    MUGSHOT_VANNAKA,
...
enum {
    ...
    B_TRANSITION_HAM, // Pokescape
    B_TRANSITION_DUKE_HORACIO,
    B_TRANSITION_SIR_AMIK_VARZE,
    B_TRANSITION_TZHAAR_CHAMPION,
    B_TRANSITION_PRINCE_ALI,
    B_TRANSITION_KING_ROALD,
    B_TRANSITION_VANNAKA,
    B_TRANSITION_THOK,
    B_TRANSITION_SIR_TIFFY,
    B_TRANSITION_HAZELMERE,
    B_TRANSITION_ZANIK,
    B_TRANSITION_HANS,
    B_TRANSITION_WISE_OLD_MAN,
    B_TRANSITION_GUNTHOR,
    B_TRANSITION_COUNT
};
