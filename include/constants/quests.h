...
#define QUEST_ARTFIGHT_JATIZSO          7   //QUEST_ARTFIGHT_JATIZSO
...
#define SUB_QUEST_COUNT ( QUEST_COOKS_ASSISTANT_SUB_COUNT + QUEST_RUNE_MYSTERIES_SUB_COUNT + QUEST_ERNEST_THE_CHICKEN_SUB_COUNT + QUEST_KOUREND_SLAYER_SUB_COUNT + QUEST_BANANA_BOAT_SUB_COUNT + QUEST_MVM_CHAMPIONSHIPS_SUB_COUNT + QUEST_MAIN_STORY_SUB_COUNT  )// + QUEST_ARTFIGHT_JATIZSO_SUB_COUNT + QUEST_ARTFIGHT_NEITIZNOT_SUB_COUNT
