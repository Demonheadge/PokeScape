...
#define QUEST_BANANA_BOAT               4   //DARK TOTEM
#define QUEST_ARTFIGHT_JATIZSO          5   //QUEST_ARTFIGHT_JATIZSO
#define QUEST_ARTFIGHT_NEITIZNOT        6
#define QUEST_COUNT                     (QUEST_BANANA_BOAT + 1)
...
#define SUB_QUEST_COUNT (QUEST_COOKS_ASSISTANT_SUB_COUNT + QUEST_RUNE_MYSTERIES_SUB_COUNT + QUEST_ERNEST_THE_CHICKEN_SUB_COUNT + QUEST_KOUREND_SLAYER_SUB_COUNT + QUEST_BANANA_BOAT_SUB_COUNT)// + QUEST_ARTFIGHT_JATIZSO_SUB_COUNT + QUEST_ARTFIGHT_NEITIZNOT_SUB_COUNT
