...
#define MOVE_LIQUEFY            (MOVES_COUNT_GEN9 + 40)
#define MOVE_CONFUSE            (MOVES_COUNT_GEN9 + 41)
#define MOVE_ANALYSE            (MOVES_COUNT_GEN9 + 42)
#define MOVE_ALCHEMY            (MOVES_COUNT_GEN9 + 43)
#define MOVE_SNARE              (MOVES_COUNT_GEN9 + 44)
#define MOVE_ENTANGLE           (MOVES_COUNT_GEN9 + 45)
#define MOVE_PUNCTURE           (MOVES_COUNT_GEN9 + 46)
#define MOVE_ICE_RUSH           (MOVES_COUNT_GEN9 + 47)
#define MOVE_ICE_BURST          (MOVES_COUNT_GEN9 + 48)
#define MOVE_ICE_BLITZ          (MOVES_COUNT_GEN9 + 49)
#define MOVE_BLOOD_RUSH         (MOVES_COUNT_GEN9 + 50)
#define MOVE_BLOOD_BURST        (MOVES_COUNT_GEN9 + 51)
#define MOVE_BLOOD_BLITZ        (MOVES_COUNT_GEN9 + 52)
#define MOVE_SMOKE_RUSH         (MOVES_COUNT_GEN9 + 53)
#define MOVE_SMOKE_BURST        (MOVES_COUNT_GEN9 + 54)
#define MOVE_SMOKE_BLITZ        (MOVES_COUNT_GEN9 + 55)
#define MOVE_SHADOW_RUSH        (MOVES_COUNT_GEN9 + 56)
#define MOVE_SHADOW_BURST       (MOVES_COUNT_GEN9 + 57)
#define MOVE_SHADOW_BLITZ       (MOVES_COUNT_GEN9 + 58)
#define MOVE_CURE_GROUP         (MOVES_COUNT_GEN9 + 59)
#define MOVE_SMITE              (MOVES_COUNT_GEN9 + 60)
#define MOVE_RETRIBUTION        (MOVES_COUNT_GEN9 + 61)
#define MOVE_MISCHIEF           (MOVES_COUNT_GEN9 + 62)
#define MOVE_RODENT_BITE        (MOVES_COUNT_GEN9 + 63)
#define MOVE_CALL_TO_ARMS       (MOVES_COUNT_GEN9 + 64)
#define MOVE_PETRIFYING_GAZE    (MOVES_COUNT_GEN9 + 65)
#define MOVE_WIND_STRIKE        (MOVES_COUNT_GEN9 + 66)
#define MOVE_WIND_BLAST         (MOVES_COUNT_GEN9 + 67)
#define MOVE_WIND_WAVE          (MOVES_COUNT_GEN9 + 68)
#define MOVE_WIND_SURGE         (MOVES_COUNT_GEN9 + 69)
#define MOVE_CRUMBLE_UNDEAD     (MOVES_COUNT_GEN9 + 70)
#define MOVE_CURE_PLANT         (MOVES_COUNT_GEN9 + 71)
#define MOVE_BACON_BLAST        (MOVES_COUNT_GEN9 + 72)
#define MOVE_TITANS_CONSTITUTION (MOVES_COUNT_GEN9 + 73)
#define MOVE_CONSPIRACY         (MOVES_COUNT_GEN9 + 74)
#define MOVE_COMMITTEE_STRIKE   (MOVES_COUNT_GEN9 + 75)
#define MOVE_CARAPACE_HARDEN    (MOVES_COUNT_GEN9 + 76)
#define MOVE_SHARKBREW          (MOVES_COUNT_GEN9 + 77)
#define MOVE_EXCALIBUR          (MOVES_COUNT_GEN9 + 78)
#define MOVE_SNELM_SHOWOFF      (MOVES_COUNT_GEN9 + 79)
#define MOVE_ENERGY_DRAIN       (MOVES_COUNT_GEN9 + 80)

#define FIRST_POKESCAPE_MOVE    MOVE_CHAOTIC_RIFT
#define LAST_POKESCAPE_MOVE     MOVE_ENERGY_DRAIN
