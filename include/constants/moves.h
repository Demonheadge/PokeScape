...
// Pokescape
#define MOVE_CHAOTIC_RIFT       (FIRST_POKESCAPE_MOVE + 1)
#define MOVE_SARADOMIN_STRIKE   (FIRST_POKESCAPE_MOVE + 2)
#define MOVE_SWORD_STRIKE       (FIRST_POKESCAPE_MOVE + 3)
#define MOVE_SLICE_DICE         (FIRST_POKESCAPE_MOVE + 4)
#define MOVE_ZAMORAK_FLAMES     (FIRST_POKESCAPE_MOVE + 5)
#define MOVE_GUTHIX_CLAWS       (FIRST_POKESCAPE_MOVE + 6)
#define MOVE_POLYPORE_STRIKE    (FIRST_POKESCAPE_MOVE + 7)
#define MOVE_ICE_BARRAGE        (FIRST_POKESCAPE_MOVE + 8)
#define MOVE_BLOOD_BARRAGE      (FIRST_POKESCAPE_MOVE + 9)
#define MOVE_VENGEANCE          (FIRST_POKESCAPE_MOVE + 10)
#define MOVE_ARMADYL_STORM      (FIRST_POKESCAPE_MOVE + 11)
#define MOVE_TUMEKEN_STORM      (FIRST_POKESCAPE_MOVE + 12)
#define MOVE_SMOKE_BARRAGE      (FIRST_POKESCAPE_MOVE + 13)
#define MOVE_SHADOW_BARRAGE     (FIRST_POKESCAPE_MOVE + 14)
#define MOVE_TELEGRAB           (FIRST_POKESCAPE_MOVE + 15)
#define MOVE_FREE_STUFF         (FIRST_POKESCAPE_MOVE + 16)
#define MOVE_BANDOS_FURY        (FIRST_POKESCAPE_MOVE + 17)
#define MOVE_ZAROS_BECKON       (FIRST_POKESCAPE_MOVE + 18)
#define MOVE_SEREN_SHINE        (FIRST_POKESCAPE_MOVE + 19)
#define MOVE_GODLESS_REBEL      (FIRST_POKESCAPE_MOVE + 20)

#define FIRST_POKESCAPE_MOVE        MOVES_COUNT_DYNAMAX
#define LAST_POKESCAPE_MOVE         MOVE_GODLESS_REBEL
