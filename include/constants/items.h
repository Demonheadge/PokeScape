...
#define ITEM_CABBAGE (FINAL_VANILLA_ITEM + 165)

// Hold items
#define ITEM_10TH_SQUAD_SIGIL (FINAL_VANILLA_ITEM + 166)
#define ITEM_ABYSSAL_WHIP (FINAL_VANILLA_ITEM + 167)
#define ITEM_AHRIMSTAFF (FINAL_VANILLA_ITEM + 168)
#define ITEM_AKRISAEMACE (FINAL_VANILLA_ITEM + 169)
#define ITEM_ARMA_HELM (FINAL_VANILLA_ITEM + 170)
#define ITEM_BLOODFURY (FINAL_VANILLA_ITEM + 171)
#define ITEM_BLUEBOATER (FINAL_VANILLA_ITEM + 172)
#define ITEM_BONECROSSBOW (FINAL_VANILLA_ITEM + 173)
#define ITEM_BRONZEHELMET (FINAL_VANILLA_ITEM + 174)
#define ITEM_DAGONHAIHAT (FINAL_VANILLA_ITEM + 175)
#define ITEM_DFS (FINAL_VANILLA_ITEM + 176)
#define ITEM_DHAROKAXE (FINAL_VANILLA_ITEM + 177)
#define ITEM_DOUBLE_EYEPATCH (FINAL_VANILLA_ITEM + 178)
#define ITEM_DRAGON_CLAWS (FINAL_VANILLA_ITEM + 179)
#define ITEM_DRAGON_DAGGER_POISON (FINAL_VANILLA_ITEM + 180)
#define ITEM_DRAGON_SCIMITAR (FINAL_VANILLA_ITEM + 181)
#define ITEM_DRUID_POUCH (FINAL_VANILLA_ITEM + 182)
#define ITEM_EFFIGY (FINAL_VANILLA_ITEM + 183)
#define ITEM_ELEMENTAL_SHIELD (FINAL_VANILLA_ITEM + 184)
#define ITEM_FIGHTER_BOOTS (FINAL_VANILLA_ITEM + 185)
#define ITEM_FIGHTER_TORSO (FINAL_VANILLA_ITEM + 186)
#define ITEM_FIRECAPE (FINAL_VANILLA_ITEM + 187)
#define ITEM_GHOSTSPEAK_AMULET (FINAL_VANILLA_ITEM + 188)
#define ITEM_GNOMEGOGGLES (FINAL_VANILLA_ITEM + 189)
#define ITEM_GNOMESCARF (FINAL_VANILLA_ITEM + 190)
#define ITEM_GODSWORD (FINAL_VANILLA_ITEM + 191)
#define ITEM_GRANITE_MAUL (FINAL_VANILLA_ITEM + 192)
#define ITEM_GUTHANSPEAR (FINAL_VANILLA_ITEM + 193)
#define ITEM_HOLY_WRENCH (FINAL_VANILLA_ITEM + 194)
#define ITEM_FANCY_BOOTS (FINAL_VANILLA_ITEM + 195)
#define ITEM_IRONMAN_HELMET (FINAL_VANILLA_ITEM + 196)
#define ITEM_ITEM_GNOMEBALL (FINAL_VANILLA_ITEM + 197)
#define ITEM_KARILCROSSBOW (FINAL_VANILLA_ITEM + 198)
#define ITEM_KERIS (FINAL_VANILLA_ITEM + 199)
#define ITEM_KRAKEN_TENTACLE (FINAL_VANILLA_ITEM + 200)
#define ITEM_LINZAHAMMER (FINAL_VANILLA_ITEM + 201)
#define ITEM_ORB_OF_OCULUS (FINAL_VANILLA_ITEM + 202)
#define ITEM_OVERLOAD (FINAL_VANILLA_ITEM + 203)
#define ITEM_PRISMATIC_STAR (FINAL_VANILLA_ITEM + 204)
#define ITEM_PULSE_CORE (FINAL_VANILLA_ITEM + 205)
#define ITEM_RING_OF_LIFE (FINAL_VANILLA_ITEM + 206)
#define ITEM_RING_OF_WEALTH (FINAL_VANILLA_ITEM + 207)
#define ITEM_ROCKCAKE (FINAL_VANILLA_ITEM + 208)
#define ITEM_SARADOMIN_BREW (FINAL_VANILLA_ITEM + 209)
#define ITEM_SICKLE (FINAL_VANILLA_ITEM + 210)
#define ITEM_SNELM (FINAL_VANILLA_ITEM + 211)
#define ITEM_SPIRITSHIELD (FINAL_VANILLA_ITEM + 212)
#define ITEM_SPOTTEDCAPE (FINAL_VANILLA_ITEM + 213)
#define ITEM_STAFF_OF_EARTH (FINAL_VANILLA_ITEM + 214)
#define ITEM_TINDERBOX (FINAL_VANILLA_ITEM + 215)
#define ITEM_TOME_OF_FROST (FINAL_VANILLA_ITEM + 216)
#define ITEM_TORAGHAMMER (FINAL_VANILLA_ITEM + 217)
#define ITEM_VERACFLAIL (FINAL_VANILLA_ITEM + 218)
#define ITEM_WATERSKIN (FINAL_VANILLA_ITEM + 219)
#define ITEM_WIZARDS_HAT (FINAL_VANILLA_ITEM + 220)
#define ITEM_WOOLBALL (FINAL_VANILLA_ITEM + 221)
#define ITEM_PHOENIX_NECKLACE (FINAL_VANILLA_ITEM + 222)
#define ITEM_MITHRIL_SCIMITAR (FINAL_VANILLA_ITEM + 223)
#define ITEM_SNOW_GLOBE (FINAL_VANILLA_ITEM + 224)

#define ITEMS_COUNT 1040
