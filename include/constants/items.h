...
#define FINAL_VANILLA_ITEM ITEM_815

// Start qol_field_moves
#define ITEM_CUT_TOOL (FINAL_VANILLA_ITEM + 1) // Axe
#define ITEM_FLY_TOOL (FINAL_VANILLA_ITEM + 2) // Flyitem
#define ITEM_SURF_TOOL (FINAL_VANILLA_ITEM + 3) // Boat
#define ITEM_STRENGTH_TOOL (FINAL_VANILLA_ITEM + 4) // Strengthitem
#define ITEM_FLASH_TOOL (FINAL_VANILLA_ITEM + 5) // Lantern
#define ITEM_ROCKSMASH_TOOL (FINAL_VANILLA_ITEM + 6) // Pickaxe
#define ITEM_WATERFALL_TOOL (FINAL_VANILLA_ITEM + 7) // Waterfallitem
#define ITEM_DIVE_TOOL (FINAL_VANILLA_ITEM + 8) // Diveitem
#define ITEM_TELEPORT_TOOL (FINAL_VANILLA_ITEM + 9) // Spade
#define ITEM_SWEETSCENT_TOOL (FINAL_VANILLA_ITEM + 10) // NA
// End qol_field_moves

// Start PokeScape

// Mega items
#define ITEM_MEGASTONE_TZHAAR (FINAL_VANILLA_ITEM + 11)
#define ITEM_MEGASTONE_TOKHAAR (FINAL_VANILLA_ITEM + 12)
#define ITEM_MEGASTONE_WARRIOR (FINAL_VANILLA_ITEM + 13)
#define ITEM_MEGASTONE_SEER (FINAL_VANILLA_ITEM + 14)
#define ITEM_MEGASTONE_ARCHER (FINAL_VANILLA_ITEM + 15)
#define ITEM_MEGASTONE_CHAOS (FINAL_VANILLA_ITEM + 16)
#define ITEM_MEGASTONE_KALPHITE (FINAL_VANILLA_ITEM + 17)
#define ITEM_MEGASTONE_BEAST (FINAL_VANILLA_ITEM + 18)

// Misc
#define ITEM_FROGEEL_BURGER (FINAL_VANILLA_ITEM + 19)
#define	ITEM_ANCIENT_SHARD (FINAL_VANILLA_ITEM + 20)
#define	ITEM_DARK_TOTEM_BASE (FINAL_VANILLA_ITEM + 21)
#define	ITEM_DARK_TOTEM_MID	(FINAL_VANILLA_ITEM + 22)
#define	ITEM_DARK_TOTEM_TOP	(FINAL_VANILLA_ITEM + 23)
#define	ITEM_DARK_TOTEM	(FINAL_VANILLA_ITEM + 24)
#define	ITEM_XERIC (FINAL_VANILLA_ITEM + 25)
#define	ITEM_SLAYER_GEM (FINAL_VANILLA_ITEM + 26)
#define ITEM_DG_BALL_OF_WOOL (FINAL_VANILLA_ITEM + 27)
#define ITEM_DG_ROPE (FINAL_VANILLA_ITEM + 28)

// Evo items
#define ITEM_AIR_RUNE (FINAL_VANILLA_ITEM + 29)
#define ITEM_WATER_RUNE (FINAL_VANILLA_ITEM + 30)
#define ITEM_EARTH_RUNE (FINAL_VANILLA_ITEM + 31)
#define ITEM_FIRE_RUNE (FINAL_VANILLA_ITEM + 32)
#define ITEM_MIND_RUNE (FINAL_VANILLA_ITEM + 33)
#define ITEM_BODY_RUNE (FINAL_VANILLA_ITEM + 34)
#define ITEM_LAW_RUNE (FINAL_VANILLA_ITEM + 35)
#define ITEM_NATURE_RUNE (FINAL_VANILLA_ITEM + 36)
#define ITEM_CHAOS_RUNE (FINAL_VANILLA_ITEM + 37)
#define ITEM_COSMIC_RUNE (FINAL_VANILLA_ITEM + 38)
#define ITEM_BLOOD_RUNE (FINAL_VANILLA_ITEM + 39)
#define ITEM_SOUL_RUNE (FINAL_VANILLA_ITEM + 40)
#define ITEM_DEATH_RUNE (FINAL_VANILLA_ITEM + 41)
#define ITEM_MUD_RUNE (FINAL_VANILLA_ITEM + 42)
#define ITEM_MIST_RUNE (FINAL_VANILLA_ITEM + 43)
#define ITEM_LAVA_RUNE (FINAL_VANILLA_ITEM + 44)
#define ITEM_DUST_RUNE (FINAL_VANILLA_ITEM + 45)
#define ITEM_ASTRAL_RUNE (FINAL_VANILLA_ITEM + 46)
#define ITEM_LIFE_RUNE (FINAL_VANILLA_ITEM + 47)
#define ITEM_SPIRIT_CHARM (FINAL_VANILLA_ITEM + 48)
#define ITEM_LEGENDARY_ITEM (FINAL_VANILLA_ITEM + 49)
#define ITEM_BAD_EGG (FINAL_VANILLA_ITEM + 50)
#define ITEM_DAGANNOTH_EGG_SHELL (FINAL_VANILLA_ITEM + 51)
#define ITEM_DAGANNOTH_SCALE (FINAL_VANILLA_ITEM + 52)
#define ITEM_NUMBLING_ROOT (FINAL_VANILLA_ITEM + 53)
#define ITEM_ROTTEN_POTATO (FINAL_VANILLA_ITEM + 54)
#define ITEM_SHRIVELLED_DAGANNOTH_CLAW (FINAL_VANILLA_ITEM + 55)
#define ITEM_SOCK (FINAL_VANILLA_ITEM + 56)
#define ITEM_TEAR_OF_GUTHIX (FINAL_VANILLA_ITEM + 57)

// Medicine
#define ITEM_BLUEBERRY_SPECIAL (FINAL_VANILLA_ITEM + 58)
#define ITEM_BREAD (FINAL_VANILLA_ITEM + 59)
#define ITEM_CHOCOLATE_CAKE (FINAL_VANILLA_ITEM + 60)
#define ITEM_CHOCOLATE_SUNDAY (FINAL_VANILLA_ITEM + 61)
#define ITEM_LAMP_ATT (FINAL_VANILLA_ITEM + 62)
#define ITEM_LAMP_DEF (FINAL_VANILLA_ITEM + 63)
#define ITEM_LAMP_HP (FINAL_VANILLA_ITEM + 64)
#define ITEM_LAMP_SPATT (FINAL_VANILLA_ITEM + 65)
#define ITEM_LAMP_SPDEF (FINAL_VANILLA_ITEM + 66)
#define ITEM_LAMP_SPEED (FINAL_VANILLA_ITEM + 67)
#define ITEM_DRUNK_DRAGON (FINAL_VANILLA_ITEM + 68)
#define ITEM_FRUIT_BLAST (FINAL_VANILLA_ITEM + 69)
#define ITEM_PINEAPPLE_PUNCH (FINAL_VANILLA_ITEM + 70)
#define ITEM_POTION_ATT (FINAL_VANILLA_ITEM + 71)
#define ITEM_POTION_DEF (FINAL_VANILLA_ITEM + 72)
#define ITEM_POTION_HP (FINAL_VANILLA_ITEM + 73)
#define ITEM_POTION_SPATT (FINAL_VANILLA_ITEM + 74)
#define ITEM_POTION_SPDEF (FINAL_VANILLA_ITEM + 75)
#define ITEM_POTION_SPEED (FINAL_VANILLA_ITEM + 76)
#define ITEM_PRAYER_POTION (FINAL_VANILLA_ITEM + 77)
#define ITEM_PURPLE_SWEETS (FINAL_VANILLA_ITEM + 78)
#define ITEM_STAT_BEER (FINAL_VANILLA_ITEM + 79)
#define ITEM_STAT_MOONLIGHT_MEAD (FINAL_VANILLA_ITEM + 80)
#define ITEM_SUPER_PRAYER_POTION (FINAL_VANILLA_ITEM + 81)
#define ITEM_WIZARDS_BLIZZARD (FINAL_VANILLA_ITEM + 82)

// Hold evos
#define ITEM_RED_SCALE (FINAL_VANILLA_ITEM + 83)
#define ITEM_GREEN_SCALE (FINAL_VANILLA_ITEM + 84)
#define ITEM_BLUE_SCALE (FINAL_VANILLA_ITEM + 85)
#define ITEM_BLACK_SCALE (FINAL_VANILLA_ITEM + 86)
#define ITEM_FRAGMENT_OF_JAS (FINAL_VANILLA_ITEM + 87)

// Misc hold items
#define ITEM_GODRABBITFOOT (FINAL_VANILLA_ITEM + 88)
#define ITEM_LUCKYRABBITFOOT (FINAL_VANILLA_ITEM + 89)

// Key items
#define ITEM_SMALL_NET (FINAL_VANILLA_ITEM + 90)
#define ITEM_BIG_NET (FINAL_VANILLA_ITEM + 91)
#define ITEM_DRAGON_NET (FINAL_VANILLA_ITEM + 92)
#define ITEM_TERRORBIRD_POUCH (FINAL_VANILLA_ITEM + 93)
#define ITEM_MAP (FINAL_VANILLA_ITEM + 94)
#define ITEM_TALISMAN_STRANGE (FINAL_VANILLA_ITEM + 95)
#define ITEM_STAKE (FINAL_VANILLA_ITEM + 96)
#define ITEM_RESEARCHNOTES (FINAL_VANILLA_ITEM + 97)
#define ITEM_DRAGONKIN_NOTES (FINAL_VANILLA_ITEM + 98)
#define ITEM_CLIMBINGBOOTS (FINAL_VANILLA_ITEM + 99) // Does nothing
#define ITEM_LOVELETTER (FINAL_VANILLA_ITEM + 100)
#define ITEM_TALISMAN_AIR (FINAL_VANILLA_ITEM + 101)
#define ITEM_TALISMAN_CHAOS (FINAL_VANILLA_ITEM + 102)
#define ITEM_TALISMAN_COSMIC (FINAL_VANILLA_ITEM + 103)
#define ITEM_TALISMAN_EARTH (FINAL_VANILLA_ITEM + 104)
#define ITEM_TALISMAN_FIRE (FINAL_VANILLA_ITEM + 105)
#define ITEM_TALISMAN_LAW (FINAL_VANILLA_ITEM + 106)
#define ITEM_TALISMAN_MIND (FINAL_VANILLA_ITEM + 107)
#define ITEM_TALISMAN_NATURE (FINAL_VANILLA_ITEM + 108)
#define ITEM_TALISMAN_SOUL (FINAL_VANILLA_ITEM + 109)
#define ITEM_TALISMAN_WATER (FINAL_VANILLA_ITEM + 110)

// Pickaxe tiers are not used currently
#define ITEM_BRONZEPICKAXE (FINAL_VANILLA_ITEM + 111)
#define ITEM_IRONPICKAXE (FINAL_VANILLA_ITEM + 112)
#define ITEM_STEELPICKAXE (FINAL_VANILLA_ITEM + 113)
#define ITEM_BLACKPICKAXE (FINAL_VANILLA_ITEM + 114)
#define ITEM_MITHRILPICKAXE (FINAL_VANILLA_ITEM + 115)
#define ITEM_ADAMANTPICKAXE (FINAL_VANILLA_ITEM + 116)
#define ITEM_RUNEPICKAXE (FINAL_VANILLA_ITEM + 117)

// Mining & Crafting items
#define ITEM_COPPER_ORE (FINAL_VANILLA_ITEM + 118)
#define ITEM_TIN_ORE (FINAL_VANILLA_ITEM + 119)
#define ITEM_IRON_ORE (FINAL_VANILLA_ITEM + 120)
#define ITEM_COAL_ORE (FINAL_VANILLA_ITEM + 121)
#define ITEM_MITHRIL_ORE (FINAL_VANILLA_ITEM + 122)
#define ITEM_ADAMANT_ORE (FINAL_VANILLA_ITEM + 123)
#define ITEM_RUNE_ORE (FINAL_VANILLA_ITEM + 124)
#define ITEM_ORIKALKUM_ORE (FINAL_VANILLA_ITEM + 125)
#define ITEM_AUGMENTOR (FINAL_VANILLA_ITEM + 126)
#define ITEM_BANE_ORE (FINAL_VANILLA_ITEM + 127)
#define ITEM_BARROWS_ITEM (FINAL_VANILLA_ITEM + 128)
#define ITEM_BLACK_MUSHROOM (FINAL_VANILLA_ITEM + 129)
#define ITEM_CRYSTAL_SHARD (FINAL_VANILLA_ITEM + 130)
#define ITEM_ELEMENTAL_ORE (FINAL_VANILLA_ITEM + 131)
#define ITEM_GRANITE (FINAL_VANILLA_ITEM + 132)
#define ITEM_HELLFIRE_METAL (FINAL_VANILLA_ITEM + 133)
#define ITEM_MYSTIC_CLOTH (FINAL_VANILLA_ITEM + 134)
#define ITEM_SPLITBARK (FINAL_VANILLA_ITEM + 135)

// Cooking
#define ITEM_EGG (FINAL_VANILLA_ITEM + 136)
#define ITEM_EMPTY_BUCKET (FINAL_VANILLA_ITEM + 137)
#define ITEM_WATER_BUCKET (FINAL_VANILLA_ITEM + 138)
#define ITEM_MILK_BUCKET (FINAL_VANILLA_ITEM + 139)
#define ITEM_WHEAT (FINAL_VANILLA_ITEM + 140)
#define ITEM_EMPTY_POT (FINAL_VANILLA_ITEM + 141)
#define ITEM_FLOUR_POT (FINAL_VANILLA_ITEM + 142)
#define ITEM_CAKE (FINAL_VANILLA_ITEM + 143)

#define ITEM_RUNE_ESSENCE (FINAL_VANILLA_ITEM + 144)
// End misc crafting

// Cooks Assistant Quest
#define ITEM_SUPER_LARGE_EGG (FINAL_VANILLA_ITEM + 145)
#define ITEM_TOP_QUALITY_MILK (FINAL_VANILLA_ITEM + 146)
#define ITEM_EXTRA_FINE_FLOUR (FINAL_VANILLA_ITEM + 147)
#define ITEM_SPECIAL_CAKE (FINAL_VANILLA_ITEM + 148)

// Ernest Quest
#define ITEM_FISH_FOOD (FINAL_VANILLA_ITEM + 149)
#define ITEM_FISH_FOOD_POISONED (FINAL_VANILLA_ITEM + 150)
#define ITEM_OIL_CAN (FINAL_VANILLA_ITEM + 151)
#define ITEM_PRESSURE_GAUGE (FINAL_VANILLA_ITEM + 152)
#define ITEM_RUBBER_TUBE (FINAL_VANILLA_ITEM + 153)
#define ITEM_MAGICAL_CAGE (FINAL_VANILLA_ITEM + 154)

// Treasures
#define ITEM_FLAX (FINAL_VANILLA_ITEM + 155)
#define ITEM_SPIRIT_SHARD (FINAL_VANILLA_ITEM + 156)
#define ITEM_MINT_CAKE (FINAL_VANILLA_ITEM + 157)
#define ITEM_HWEEN_MASK (FINAL_VANILLA_ITEM + 158)
#define ITEM_SANTA_HAT (FINAL_VANILLA_ITEM + 159)
#define ITEM_PARTY_HAT (FINAL_VANILLA_ITEM + 160)
#define ITEM_YAK_POUCH (FINAL_VANILLA_ITEM + 161)
#define ITEM_VANILLA_MILK (FINAL_VANILLA_ITEM + 162)
#define ITEM_STRAWBERRY_MILK (FINAL_VANILLA_ITEM + 163)
#define ITEM_CHOCOLATE_MILK (FINAL_VANILLA_ITEM + 165)
#define ITEM_CABBAGE (FINAL_VANILLA_ITEM + 166)

// Hold items
#define ITEM_10TH_SQUAD_SIGIL (FINAL_VANILLA_ITEM + 167)
#define ITEM_ABYSSAL_WHIP (FINAL_VANILLA_ITEM + 168)
#define ITEM_AHRIMSTAFF (FINAL_VANILLA_ITEM + 169)
#define ITEM_AKRISAEMACE (FINAL_VANILLA_ITEM + 170)
#define ITEM_ARMA_HELM (FINAL_VANILLA_ITEM + 171)
#define ITEM_BLOODFURY (FINAL_VANILLA_ITEM + 172)
#define ITEM_BLUEBOATER (FINAL_VANILLA_ITEM + 173)
#define ITEM_BONECROSSBOW (FINAL_VANILLA_ITEM + 174)
#define ITEM_BRONZEHELMET (FINAL_VANILLA_ITEM + 175)
#define ITEM_DAGONHAIHAT (FINAL_VANILLA_ITEM + 176)
#define ITEM_DFS (FINAL_VANILLA_ITEM + 177)
#define ITEM_DHAROKAXE (FINAL_VANILLA_ITEM + 178)
#define ITEM_DOUBLE_EYEPATCH (FINAL_VANILLA_ITEM + 179)
#define ITEM_DRAGON_CLAWS (FINAL_VANILLA_ITEM + 180)
#define ITEM_DRAGON_DAGGER_POISON (FINAL_VANILLA_ITEM + 181)
#define ITEM_DRAGON_SCIMITAR (FINAL_VANILLA_ITEM + 182)
#define ITEM_DRUID_POUCH (FINAL_VANILLA_ITEM + 183)
#define ITEM_EFFIGY (FINAL_VANILLA_ITEM + 184)
#define ITEM_ELEMENTAL_SHIELD (FINAL_VANILLA_ITEM + 185)
#define ITEM_FIGHTER_BOOTS (FINAL_VANILLA_ITEM + 186)
#define ITEM_FIGHTER_TORSO (FINAL_VANILLA_ITEM + 187)
#define ITEM_FIRECAPE (FINAL_VANILLA_ITEM + 188)
#define ITEM_GHOSTSPEAK_AMULET (FINAL_VANILLA_ITEM + 189)
#define ITEM_GNOMEGOGGLES (FINAL_VANILLA_ITEM + 190)
#define ITEM_GNOMESCARF (FINAL_VANILLA_ITEM + 191)
#define ITEM_GODSWORD (FINAL_VANILLA_ITEM + 192)
#define ITEM_GRANITE_MAUL (FINAL_VANILLA_ITEM + 193)
#define ITEM_GUTHANSPEAR (FINAL_VANILLA_ITEM + 194)
#define ITEM_HOLY_WRENCH (FINAL_VANILLA_ITEM + 195)
#define ITEM_FANCY_BOOTS (FINAL_VANILLA_ITEM + 196)
#define ITEM_IRONMAN_HELMET (FINAL_VANILLA_ITEM + 197)
#define ITEM_ITEM_GNOMEBALL (FINAL_VANILLA_ITEM + 198)
#define ITEM_KARILCROSSBOW (FINAL_VANILLA_ITEM + 199)
#define ITEM_KERIS (FINAL_VANILLA_ITEM + 200)
#define ITEM_KRAKEN_TENTACLE (FINAL_VANILLA_ITEM + 201)
#define ITEM_LINZAHAMMER (FINAL_VANILLA_ITEM + 202)
#define ITEM_ORB_OF_OCULUS (FINAL_VANILLA_ITEM + 203)
#define ITEM_OVERLOAD (FINAL_VANILLA_ITEM + 204)
#define ITEM_PRISMATIC_STAR (FINAL_VANILLA_ITEM + 205)
#define ITEM_PULSE_CORE (FINAL_VANILLA_ITEM + 206)
#define ITEM_RING_OF_LIFE (FINAL_VANILLA_ITEM + 207)
#define ITEM_RING_OF_WEALTH (FINAL_VANILLA_ITEM + 208)
#define ITEM_ROCKCAKE (FINAL_VANILLA_ITEM + 209)
#define ITEM_SARADOMIN_BREW (FINAL_VANILLA_ITEM + 210)
#define ITEM_SICKLE (FINAL_VANILLA_ITEM + 211)
#define ITEM_SNELM (FINAL_VANILLA_ITEM + 212)
#define ITEM_SPIRITSHIELD (FINAL_VANILLA_ITEM + 213)
#define ITEM_SPOTTEDCAPE (FINAL_VANILLA_ITEM + 214)
#define ITEM_STAFF_OF_EARTH (FINAL_VANILLA_ITEM + 215)
#define ITEM_TINDERBOX (FINAL_VANILLA_ITEM + 216)
#define ITEM_TOME_OF_FROST (FINAL_VANILLA_ITEM + 217)
#define ITEM_TORAGHAMMER (FINAL_VANILLA_ITEM + 218)
#define ITEM_VERACFLAIL (FINAL_VANILLA_ITEM + 219)
#define ITEM_WATERSKIN (FINAL_VANILLA_ITEM + 220)
#define ITEM_WIZARDS_HAT (FINAL_VANILLA_ITEM + 221)
#define ITEM_WOOLBALL (FINAL_VANILLA_ITEM + 222)
#define ITEM_PHOENIX_NECKLACE (FINAL_VANILLA_ITEM + 223)
#define ITEM_MITHRIL_SCIMITAR (FINAL_VANILLA_ITEM + 224)
#define ITEM_SNOW_GLOBE (FINAL_VANILLA_ITEM + 225)

#define ITEM_FARMING_CABBAGE (FINAL_VANILLA_ITEM + 226)
#define ITEM_APPLE (FINAL_VANILLA_ITEM + 227)
#define ITEM_BANANA (FINAL_VANILLA_ITEM + 228)
#define ITEM_CADAVABERRY (FINAL_VANILLA_ITEM + 229)
#define ITEM_COCONUT (FINAL_VANILLA_ITEM + 230)
#define ITEM_CORN (FINAL_VANILLA_ITEM + 231)
#define ITEM_GARLIC (FINAL_VANILLA_ITEM + 232)
#define ITEM_GRAPES (FINAL_VANILLA_ITEM + 233)
#define ITEM_JANGERBERRY (FINAL_VANILLA_ITEM + 234)
#define ITEM_LEMON (FINAL_VANILLA_ITEM + 235)
#define ITEM_ONION (FINAL_VANILLA_ITEM + 236)
#define ITEM_ORANGE (FINAL_VANILLA_ITEM + 237)
#define ITEM_PINEAPPLE (FINAL_VANILLA_ITEM + 238)
#define ITEM_POISONIVYBERRY (FINAL_VANILLA_ITEM + 239)
#define ITEM_POTATO (FINAL_VANILLA_ITEM + 240)
#define ITEM_REDBERRY (FINAL_VANILLA_ITEM + 241)
#define ITEM_STRAWBERRY (FINAL_VANILLA_ITEM + 242)
#define ITEM_TOMATO (FINAL_VANILLA_ITEM + 243)
#define ITEM_TURNIP (FINAL_VANILLA_ITEM + 244)
#define ITEM_WATERMELON (FINAL_VANILLA_ITEM + 245)
#define ITEM_WHITEBERRY (FINAL_VANILLA_ITEM + 246)

#define ITEM_SCURRIUS_CHEESE (FINAL_VANILLA_ITEM + 247)
#define ITEM_TALISMAN_MYSTERY (FINAL_VANILLA_ITEM + 248)
#define ITEM_CRANDOR_MAP_FULL (FINAL_VANILLA_ITEM + 249)
#define ITEM_CRANDOR_MAP_PIECE1 (FINAL_VANILLA_ITEM + 250)
#define ITEM_CRANDOR_MAP_PIECE2 (FINAL_VANILLA_ITEM + 251)
#define ITEM_CRANDOR_MAP_PIECE3 (FINAL_VANILLA_ITEM + 252)
