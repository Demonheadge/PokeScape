...
#define HOLD_EFFECTS_POKEEMERALD_END HOLD_EFFECT_BERSERK_GENE

// pokescape holdeffects
#define HOLD_EFFECT_RANDOM_STAT_DOWN (HOLD_EFFECTS_POKEEMERALD_END + 1)
#define HOLD_EFFECT_SNELM            (HOLD_EFFECTS_POKEEMERALD_END + 2)
#define HOLD_EFFECT_SPIRIT_SHIELD    (HOLD_EFFECTS_POKEEMERALD_END + 3)
#define HOLD_EFFECT_VERAC            (HOLD_EFFECTS_POKEEMERALD_END + 4)
#define HOLD_EFFECT_DHAROK           (HOLD_EFFECTS_POKEEMERALD_END + 5)
#define HOLD_EFFECT_KARIL            (HOLD_EFFECTS_POKEEMERALD_END + 6)
#define HOLD_EFFECT_AHRIM            (HOLD_EFFECTS_POKEEMERALD_END + 7)
#define HOLD_EFFECT_TORAG            (HOLD_EFFECTS_POKEEMERALD_END + 8)
#define HOLD_EFFECT_PRESSURE         (HOLD_EFFECTS_POKEEMERALD_END + 9)
#define HOLD_EFFECT_GODSWORD         (HOLD_EFFECTS_POKEEMERALD_END + 10)
#define HOLD_EFFECT_DFS              (HOLD_EFFECTS_POKEEMERALD_END + 11)
#define HOLD_EFFECT_WEATHER_EXTENDER (HOLD_EFFECTS_POKEEMERALD_END + 12)
#define HOLD_EFFECT_EVO_ATTACK       (HOLD_EFFECTS_POKEEMERALD_END + 13)
#define HOLD_EFFECT_EXTEND_TAILWIND  (HOLD_EFFECTS_POKEEMERALD_END + 14)
#define HOLD_EFFECT_REMOVE_WEATHER   (HOLD_EFFECTS_POKEEMERALD_END + 15)
