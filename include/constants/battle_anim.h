...
#define ANIM_TAG_FINAL_VANILLA              ANIM_TAG_SYRUP_SPLAT_YELLOW

#define ANIM_TAG_SWORD_STRIKE               (ANIM_TAG_FINAL_VANILLA + 1)
#define ANIM_TAG_SARADOMIN_STRIKE           (ANIM_TAG_FINAL_VANILLA + 2)
#define ANIM_TAG_POLYPORE_STRIKE            (ANIM_TAG_FINAL_VANILLA + 3)
#define ANIM_TAG_BLOOD_BUBBLE               (ANIM_TAG_FINAL_VANILLA + 4)
#define ANIM_TAG_BLOOD_BARRAGE_PARTICLES    (ANIM_TAG_FINAL_VANILLA + 5)
#define ANIM_TAG_VENGEANCE                  (ANIM_TAG_FINAL_VANILLA + 6)
#define ANIM_TAG_TELEGRAB                   (ANIM_TAG_FINAL_VANILLA + 7)
