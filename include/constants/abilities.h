...
#define FINAL_VANILLA_ABILITY ABILITY_310

//POKESCAPE
#define ABILITY_GLORY (FINAL_VANILLA_ABILITY + 1)
#define ABILITY_EMPTY_LORD (FINAL_VANILLA_ABILITY + 2)
#define ABILITY_CRYSTAL_BEING (FINAL_VANILLA_ABILITY + 3)
#define ABILITY_SWIFT_MIND (FINAL_VANILLA_ABILITY + 4)
#define ABILITY_UNDERDOG (FINAL_VANILLA_ABILITY + 5)
#define ABILITY_MENAPHITE (FINAL_VANILLA_ABILITY + 6)
#define ABILITY_PETRIFY (FINAL_VANILLA_ABILITY + 7)
#define ABILITY_ABYSSAL (FINAL_VANILLA_ABILITY + 8)
#define ABILITY_SEEKER (FINAL_VANILLA_ABILITY + 9)
#define ABILITY_HAEMANCY (FINAL_VANILLA_ABILITY + 10)
#define ABILITY_PINCERS (FINAL_VANILLA_ABILITY + 11)
#define ABILITY_GOOSEBUMPS (FINAL_VANILLA_ABILITY + 12)
#define ABILITY_AVERNIC (FINAL_VANILLA_ABILITY +13)
#define ABILITY_FIRE_SHIELD (FINAL_VANILLA_ABILITY + 14)
#define ABILITY_HUNTER (FINAL_VANILLA_ABILITY + 15)

#define ABILITIES_COUNT_POKESCAPE (FINAL_VANILLA_ABILITY + 16)

#define ABILITIES_COUNT ABILITIES_COUNT_POKESCAPE
