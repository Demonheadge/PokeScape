...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_FALADOR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_RIMMINGTON] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VARROCK] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_WIZARDS_TOWER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_LUMBRIDGE_FOREST] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KARAMJA_VOLCANO] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ASGARNIAN_DUNGEON] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_MOR_UL_REK] = MAPPOPUP_THEME_STONE,
