...
const u32 gTrainerCard_F2P_Front_Tilemap[] = INCBIN_U32("graphics/trainer_card/front_F2P.bin.lz");
const u32 gTrainerCard_P2P_Front_Tilemap[] = INCBIN_U32("graphics/trainer_card/front_P2P.bin.lz");
