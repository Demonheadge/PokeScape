...
static const u16 sPrizeListLuxuryBall1[] = {ITEM_ROYAL_POUCH,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
...
static const u16 sPrizeListLuxuryBall2[] = {ITEM_ROYAL_POUCH,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
