...
static const u16 sPrizeListRareCandy1[]  = {ITEM_RARE_CANDY,        ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_EMBROIDERED_POUCH, ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_MAX_REVIVE,        ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListMaxEther1[]   = {ITEM_MAX_ETHER,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListElixir1[]     = {ITEM_ELIXIR,            ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListRoar[]        = {ITEM_TM_SNARL,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_TM_SLUDGE_WAVE,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListToxic[]       = {ITEM_TM_TOXIC,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_SUNNY_DAY,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListEarthQuake[]  = {ITEM_TM_AERIAL_ACE,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};

static const u16 sPrizeListRareCandy2[]  = {ITEM_RARE_CANDY,        ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_EMBROIDERED_POUCH, ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_MAX_REVIVE,        ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListMaxEther2[]   = {ITEM_MAX_ETHER,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListElixir2[]     = {ITEM_ELIXIR,            ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListBrickBreak[]  = {ITEM_TM_ICE_BEAM,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListTorment[]     = {ITEM_TM_POWDER,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListSkillSwap[]   = {ITEM_TM_SWORDS_DANCE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListGigaDrain[]   = {ITEM_TM_GRASSY_TERRAIN, ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
static const u16 sPrizeListAttract[]     = {ITEM_TM_TOXIC,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_BRONZE_POUCH};
