...
{
    {gTrainerBackPic_protaganist_m + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_m + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_m + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_m + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_May[] =
{
    {gTrainerBackPic_protaganist_f + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_f + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_f + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_protaganist_f + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct SpriteFrameImage gTrainerBackPicTable_Zanik[] =
{
    {gTrainerBackPic_Zanik + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Zanik + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Zanik + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Zanik + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Ariane[] =
{
    {gTrainerBackPic_Ariane + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ariane + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ariane + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ariane + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Owen[] =
{
    {gTrainerBackPic_Owen + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Owen + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Owen + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Owen + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
