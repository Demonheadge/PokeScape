const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_JMOD_M] = TRAINER_PIC_jmod_m,
    [FACILITY_CLASS_JMOD_F] = TRAINER_PIC_jmod_f,
    [FACILITY_CLASS_BRONZE_MAN] = TRAINER_PIC_lukien,
    [FACILITY_CLASS_IRONMAN] = TRAINER_PIC_ironman,
    [FACILITY_CLASS_MITHRIL_MAN] = TRAINER_PIC_mithrilman,
    [FACILITY_CLASS_RUNE_MAN] = TRAINER_PIC_noob_rune,
    [FACILITY_CLASS_DEMONHEADGE] = TRAINER_PIC_demonheadge,
    [FACILITY_CLASS_HYPERSTAN] = TRAINER_PIC_hyperstan,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_JMOD_M] = TRAINER_CLASS_JMOD,
    [FACILITY_CLASS_JMOD_F] = TRAINER_CLASS_JMOD,
    [FACILITY_CLASS_BRONZE_MAN] = TRAINER_CLASS_NOOB,
    [FACILITY_CLASS_IRONMAN] = TRAINER_CLASS_IRONMAN,
    [FACILITY_CLASS_MITHRIL_MAN] = TRAINER_CLASS_MITHRILMAN,
    [FACILITY_CLASS_RUNE_MAN] = TRAINER_CLASS_NOOB,
    [FACILITY_CLASS_DEMONHEADGE] = TRAINER_CLASS_POKESCAPER,
    [FACILITY_CLASS_HYPERSTAN] = TRAINER_CLASS_POKESCAPER,
};
