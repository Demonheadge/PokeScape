...
//POKESCAPE
static const struct FormChange sSailfishFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_THALLASUS, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sHellhoundFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CERBERUS, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sKalphiteQueenFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_KALPHITE_QUEEN_MEGA_FORM, ITEM_MEGASTONE_KALPHITE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sWolpertingerFormChangeTable[] = {
    //{FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_WOLPERTING_MEGA_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDagannothKingFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_DAGANNOTH_KING_MELEE_MEGA_FORM, ITEM_MEGASTONE_WARRIOR},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_DAGANNOTH_KING_MAGIC_MEGA_FORM, ITEM_MEGASTONE_SEER},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_DAGANNOTH_KING_RANGE_MEGA_FORM, ITEM_MEGASTONE_ARCHER},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGlacorFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_GLACOR_ARCH_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGuthixianButterflyFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TREBORN, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sTzTokJadFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TZTOK_JAD_HD_MEGA_FORM, ITEM_MEGASTONE_TZHAAR},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TZTOK_JAD_RS3_MEGA_FORM, ITEM_MEGASTONE_TOKHAAR},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sWolfSpiritFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_HELWYR, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sChaosElementalFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CHAOS_ELE_MEGA_FORM, ITEM_MEGASTONE_CHAOS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sWallBeastFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_WALL_BEAST_MEGA_FORM, ITEM_MEGASTONE_BEAST},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sStoneOfJasFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_STONE_OF_JAS_MEGA_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCuteCreatureFormChangeTable[] = {
    {FORM_CHANGE_FAINT,         SPECIES_CREATURE_CUTE_FORM},
    {FORM_CHANGE_END_BATTLE,    SPECIES_CREATURE_CUTE_FORM},
    {FORM_CHANGE_TERMINATOR},
};

//Todo
static const struct FormChange sZulrahFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_ZULRAH_MAGMA_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_ZULRAH_SERPENTINE_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_ZULRAH_TANZANITE_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sFleshSpoilerFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_FLESH_SPOILER_COVERED_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_FLESH_SPOILER_NAKED_FORM, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sTomeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TOME_OF_MAGIC, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TOME_OF_RANGED, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TOME_OF_STRENGTH, ITEM_FRAGMENT_OF_JAS},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sStrykewyrmFormChangeTable[] = {

    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_FREEZY_FORM, BATTLE_TERRAIN_SNOW},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_FREEZY_FORM, BATTLE_TERRAIN_ICE},

    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_LEAFY_FORM, BATTLE_TERRAIN_SWAMP},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_LEAFY_FORM, BATTLE_TERRAIN_MARSH},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_LEAFY_FORM, BATTLE_TERRAIN_POKESCAPE_BARROWS},

    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_SANDY_FORM, BATTLE_TERRAIN_SAND},

    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_WILDY_FORM, BATTLE_TERRAIN_POKESCAPE_WILDERNESS},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_WILDY_FORM, BATTLE_TERRAIN_POKESCAPE_TZHAAR},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_STRYKEWYRM_WILDY_FORM, BATTLE_TERRAIN_POKESCAPE_TZHAAR_LAVA},
    {FORM_CHANGE_TERMINATOR},
};
