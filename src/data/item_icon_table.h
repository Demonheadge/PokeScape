const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_DRAGON_POUCH] = {gItemIcon_CrystalPouch, gItemIconPalette_CrystalPouch},
    [ITEM_PREMIER_BALL] = {gItemIcon_PremierBall, gItemIconPalette_LuxuryBall},
    [ITEM_BLESSED_POUCH] = {gItemIcon_HealBall, gItemIconPalette_HealBall},
    [ITEM_LEATHER_POUCH] = {gItemIcon_NetBall, gItemIconPalette_NetBall},
    [ITEM_ELEMENTAL_POUCH] = {gItemIcon_NestBall, gItemIconPalette_NestBall},
    [ITEM_CATALYTIC_POUCH] = {gItemIcon_DiveBall, gItemIconPalette_DiveBall},
    [ITEM_CRYSTAL_POUCH] = {gItemIcon_DuskBall, gItemIconPalette_DuskBall},
    [ITEM_ADAMANT_POUCH] = {gItemIcon_TimerBall, gItemIconPalette_RepeatBall},
    [ITEM_MITHRIL_POUCH] = {gItemIcon_QuickBall, gItemIconPalette_QuickBall},
    [ITEM_AUGMENTED_POUCH] = {gItemIcon_RepeatBall, gItemIconPalette_RepeatBall},
    [ITEM_EMBROIDERED_POUCH] = {gItemIcon_LuxuryBall, gItemIconPalette_LuxuryBall},
    [ITEM_BARROWS_POUCH] = {gItemIcon_LevelBall, gItemIconPalette_LevelBall},
    [ITEM_SPIDERSILK_POUCH] = {gItemIcon_LureBall, gItemIconPalette_LureBall},
    [ITEM_ANCIENT_POUCH] = {gItemIcon_MoonBall, gItemIconPalette_MoonBall},
    [ITEM_ROYAL_POUCH] = {gItemIcon_FriendBall, gItemIconPalette_FriendBall},
    [ITEM_MYSTIC_POUCH] = {gItemIcon_LoveBall, gItemIconPalette_LoveBall},
    [ITEM_DRAGONBANE_POUCH] = {gItemIcon_FastBall, gItemIconPalette_FastBall},
    [ITEM_GRANITE_POUCH] = {gItemIcon_HeavyBall, gItemIconPalette_HeavyBall},
    ...
    [ITEM_BLACK_POUCH] = {gItemIcon_ParkBall, gItemIconPalette_ParkBall},
