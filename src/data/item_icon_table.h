const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_SNAKESKIN_POUCH] = {gItemIcon_QuickBall, gItemIconPalette_QuickBall},
    [ITEM_REPEAT_BALL] = {gItemIcon_RepeatBall, gItemIconPalette_RepeatBall},
    [ITEM_ROYAL_POUCH] = {gItemIcon_LuxuryBall, gItemIconPalette_LuxuryBall},
    [ITEM_SACRED_POUCH] = {gItemIcon_LevelBall, gItemIconPalette_LevelBall},
    [ITEM_LURE_BALL] = {gItemIcon_LureBall, gItemIconPalette_LureBall},
    [ITEM_MOON_BALL] = {gItemIcon_MoonBall, gItemIconPalette_MoonBall},
    [ITEM_BLESSED_POUCH] = {gItemIcon_FriendBall, gItemIconPalette_FriendBall},
