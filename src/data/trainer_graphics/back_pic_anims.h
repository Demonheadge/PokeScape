...
static const union AnimCmd sAnimCmd_Zanik_1[] =
{
    ANIMCMD_FRAME(0, 24),
    ANIMCMD_FRAME(1, 9),
    ANIMCMD_FRAME(2, 24),
...
static const union AnimCmd sAnimCmd_Ariane_1[] =
{
    ANIMCMD_FRAME(0, 24),
    ANIMCMD_FRAME(1, 9),
    ANIMCMD_FRAME(2, 24),
...
static const union AnimCmd sAnimCmd_Owen_1[] =
{
    ANIMCMD_FRAME(0, 24),
    ANIMCMD_FRAME(1, 9),
    ANIMCMD_FRAME(2, 24),
...
static const union AnimCmd *const sBackAnims_Zanik[] =
{
    sAnim_GeneralFrame3,
    sAnimCmd_Zanik_1,
};

static const union AnimCmd *const sBackAnims_Ariane[] =
{
    sAnim_GeneralFrame3,
    sAnimCmd_Ariane_1,
};

static const union AnimCmd *const sBackAnims_Owen[] =
{
    sAnim_GeneralFrame3,
    sAnimCmd_Owen_1,
};
...
const union AnimCmd *const *const gTrainerBackAnimsPtrTable[] =
{
    ...
    [TRAINER_BACK_PIC_ZANIK] = sBackAnims_Zanik,
    [TRAINER_BACK_PIC_ARIANE] = sBackAnims_Ariane,
    [TRAINER_BACK_PIC_OWEN] = sBackAnims_Owen,
};
