...
{
    [FRONTIER_FACILITY_TOWER]   = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_DOME]    = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_PALACE]  = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_ARENA]   = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_FACTORY] = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_PIKE]    = TRAINER_DEMONHEADGE,
    [FRONTIER_FACILITY_PYRAMID] = TRAINER_DEMONHEADGE,
};
