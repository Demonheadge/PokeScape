...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_RIMMINGTON] = {MAP_GROUP(RIMMINGTON), MAP_NUM(RIMMINGTON), HEAL_LOCATION_RIMMINGTON},
    [MAPSEC_TAVERLEY] = {MAP_GROUP(TAVERLEY), MAP_NUM(TAVERLEY), HEAL_LOCATION_TAVERLEY},
    [MAPSEC_FALADOR] = {MAP_GROUP(FALADOR), MAP_NUM(FALADOR), HEAL_LOCATION_FALADOR},
    [MAPSEC_BARBARIAN_VILLAGE] = {MAP_GROUP(BARBARIAN_VILLAGE), MAP_NUM(BARBARIAN_VILLAGE), HEAL_LOCATION_BARBARIAN_VILLAGE},
    [MAPSEC_VARROCK] = {MAP_GROUP(VARROCK), MAP_NUM(VARROCK), HEAL_LOCATION_VARROCK},
...
//PokeScape
    ...
    case MAPSEC_DRAYNOR:
        return FlagGet(FLAG_VISITED_DRAYNOR) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PORT_SARIM:
        return FlagGet(FLAG_VISITED_PORT_SARIM) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RIMMINGTON:
        return FlagGet(FLAG_VISITED_RIMMINGTON) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_TAVERLEY:
        return FlagGet(FLAG_VISITED_TAVERLEY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FALADOR:
        return FlagGet(FLAG_VISITED_FALADOR) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BARBARIAN_VILLAGE:
        return FlagGet(FLAG_VISITED_BARBARIAN_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VARROCK:
        return FlagGet(FLAG_VISITED_VARROCK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_EDGEVILLE:
        return FlagGet(FLAG_VISITED_EDGEVILLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ALKHARID:
